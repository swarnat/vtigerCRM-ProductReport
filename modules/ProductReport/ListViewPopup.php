...
<div style="background-color:#ffffea;border:1px solid #129456;width:250px;padding:20px;left:20px;position:relative;box-shadow:0px 0 2px #777777;">
    ...
    <img src="modules/ProductReport/icons/calenderButton.png" style="margin-bottom:-8px;cursor:pointer;" id="jscal_trigger_pr_date_from">
    ...
    <img src="modules/ProductReport/icons/calenderButton.png" style="margin-bottom:-8px;cursor:pointer;" id="jscal_trigger_pr_date_to">
    ...
    <br><br><br>
    <span style='font-size:11px;color:#999;font-weight:bold;'>Extension developed by <a href='http://vtiger.stefanwarnat.de/?utm_source=extension&utm_medium=link&utm_campaign=ProductReport' target="_blank" style='font-size:11px;color:#555;text-decoration:underline;font-weight:bold;'>Stefan Warnat</a>
    </span>
</div>